...
public class WitnessReportHandler implements MenuActionHandler {
    private final CaseService caseService;

    @Override
    public String getName() {
        return "witnessReportHandler";
    }
    ...
    public void handle(String userNumber, String input, Map<String, Object> context) {
        ...
        UUID caseId = caseService.createCase(CaseType.WITNESS, input, lang);
